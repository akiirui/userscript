// ==UserScript==
// @name                Play with MPV (NSFW)
// @name:en-US          Play with MPV (NSFW)
// @name:zh-CN          使用 MPV 播放 (NSFW)
// @name:zh-TW          使用 MPV 播放 (NSFW)
// @description         Play videos and songs on the website via mpv-handler (NSFW)
// @description:en-US   Play videos and songs on the website via mpv-handler (NSFW)
...
const MATCHERS = {
  "www.pornhub.com": /www.pornhub.com\/view_video\.php/gi,
};
